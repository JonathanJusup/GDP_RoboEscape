...
public class Menu : MonoBehaviour {
    ...
    void Start() {
        ...
        dropdownResolutions.SetValueWithoutNotify(PlayerPrefs.GetInt("masterResolution",
            dropdownResolutions.options.Count));
    }
    ...
    private void InitResolutionDropdown() {
        ...
        //Filter resolutions with same refreshRate
